 ...
 *
 */
public abstract class DelayedEntityProcessingSystem extends BaseEntitySystem {
	protected boolean running;
	protected float delay;
	protected float acc;
	protected float defaultDelay;

	public DelayedEntityProcessingSystem(Aspect aspect, float defaultDelay) {
		super(aspect);
...
//					log("offering remaining " + remaining);
...
//		System.out.println("restarting " + delay);
		this.delay = delay;
		this.acc = 0;
		running = true;
	}
